...
RUN apt-get -y install apt-transport-https lsb-release ca-certificates curl gnupg2 apt-utils git sudo zip socat zstd neovim argon2
...
# Install PHP
RUN apt-get install -y php$PHP_VERSION-fpm php$PHP_VERSION-pgsql php$PHP_VERSION-curl php$PHP_VERSION-zip php$PHP_VERSION-xml php$PHP_VERSION-mbstring php$PHP_VERSION-intl php$PHP_VERSION-gd php$PHP_VERSION-soap php$PHP_VERSION-apcu php$PHP_VERSION-redis php$PHP_VERSION-sqlite3
